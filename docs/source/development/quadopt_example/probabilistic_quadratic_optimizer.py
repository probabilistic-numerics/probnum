...
class ProbabilisticQuadraticOptimizer:
    ...
    def optim_iterator(
        ...
        fun_params :
            Belief about the parameters of the objective function.
        """
        while True:
    ...
    def optimize(
        ...
        fun_opt :
            Belief about the optimal value of the objective function.
        fun_params :
            Belief about the parameters of the objective function.
        info :
        ...
        # Belief about optimal function value and optimum
