...
from probnum.linalg.solvers import ProbabilisticLinearSolverState, information_ops
...
def test_is_A_matvec(
    info_op: information_ops.LinearSolverInfoOp, state: ProbabilisticLinearSolverState
):
