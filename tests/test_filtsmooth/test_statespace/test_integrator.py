...
def test_convert_coordwise_to_derivwise(in_out_pair, some_order, some_dim):
    derivwise, coordwise = in_out_pair
    coordwise_as_derivwise = pnfss.convert_coordwise_to_derivwise(
...
def test_convert_derivwise_to_coordwise(in_out_pair, some_order, some_dim):
    derivwise, coordwise = in_out_pair
    derivwise_as_coordwise = pnfss.convert_derivwise_to_coordwise(
...
def test_conversion_pairwise_inverse(in_out_pair, some_order, some_dim):
    derivwise, coordwise = in_out_pair
    as_coord = pnfss.convert_derivwise_to_coordwise(derivwise, some_order, some_dim)
    as_deriv_again = pnfss.convert_coordwise_to_derivwise(
