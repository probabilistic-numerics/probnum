...
# There is a weird jax problem, below is a temporary fix (warning: all tests below will be skipped).
only_if_jax_available = pytest.mark.skip
only_if_jax_is_not_available = pytest.mark.skip
