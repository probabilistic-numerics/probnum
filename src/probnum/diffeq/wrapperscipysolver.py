...
from probnum.diffeq import wrapperscipyodesolution as scisol


class WrapperScipyODESolver(diffeq.ODESolver):
...
class WrapperScipyRungeKutta(WrapperScipyODESolver):
    ...
    def rvlist_to_odesol(self, times, rvs):
        ...
        probnum_solution = scisol.WrapperScipyODESolution(
