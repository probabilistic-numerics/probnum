...
HyperparameterOptimization.__module__ = "probnum.linalg.solvers.hyperparam_optim"
UncertaintyCalibration.__module__ = "probnum.linalg.solvers.hyperparam_optim"
OptimalNoiseScale.__module__ = "probnum.linalg.solvers.hyperparam_optim"
